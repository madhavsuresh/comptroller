from flask.ext.wtf import Form, TextField, BooleanField,SelectField,validators,TextAreaField,IntegerField,html5
import constants
...
class RegistrationForm(Form):
    name = TextField('Name', [validators.length(max=constants.MAX_NAME),validators.required()])
